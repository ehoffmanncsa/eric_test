...
# C3PO Regression
# UI Test: My Information for prem users only.
...
class AddMyInformationTestPrem < Common
  def setup
    super
  ...
  def add_premium
    ...
    POSSetup.set_guardian(@guardian_email1)
  ...
  # do not enter a new guardian email or no pdf/welcome email will be sent
  ...
  def verify_header_info
    ...
    expected_header_con = "#{@recruit_first_name.downcase}.#{@recruit_last_name.downcase}@test.recruitinginfo.org"+
  ...
  def check_profile_history_contact
    ...
    "\n#{@recruit_first_name.downcase}.#{@recruit_last_name.downcase}@test.recruitinginfo.org"+
  ...
  def test_add_my_information
    ...
    #guardian1_email_enter --- do not enter a new guardian email or no pdf/welcome email
    relationship2_enter
