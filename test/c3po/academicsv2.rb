...
I am some SAT notes'
  ...
  def check_contact
    ...
    expected_contact = 'ROSENDO FRIESEN (Athlete)
test+790c@yopmail.com
(917) 777-3707'
    actual_contact = @browser.element(:class, %w[half mg-btm-1]).text
    msg = "contact: #{actual_contact} not as expected: #{expected_contact}"
    failure << msg unless actual_contact.eql? expected_contact
